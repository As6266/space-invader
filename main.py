...
pygame.display.set_icon(RED_SPACESHIP)
...
def yellow_handle_maovement(keys_pressed, yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VEL > 0 : #Move Left
        yellow.x -= VEL
    if keys_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x + 25 : #Move Right
        yellow.x += VEL
...
def red_handle_maovement(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL + red.width > BORDER.x + 50  : #Move Left
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x + VEL + red.width  < WIDTH + 15 : #Move Right
        red.x += VEL
...
def main():
    ...
    while run:
        ...
        yellow_handle_maovement(keys_pressed, yellow)
        red_handle_maovement(keys_pressed, red)
